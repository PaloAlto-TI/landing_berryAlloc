    ...
    return (
        <footer className="main-footer">
            <Row>
                ...
                <Col span={8} className="labels-footer">With <a href={'https://www.youtube.com/watch?v=ZZmW0iiRGAs'} target="_blank" rel="noreferrer"><HeartOutlined spin="true" style={{ fontSize: '16px', color: 'rgb(255 0 0)' }}/></a> TI</Col>
